...
<section class="main">
  <div class="wrap">
    <h1>Pääotsikko</h1>
    <p>Tähän tulee sivun pääsisältö muistathan, ettei sinulla ole oikeuksia muuttaa section nimeä, vaan sen tulee olla main!
    Mikäli haluat lisätä omia tyylejäsi tähän osioon sinun tulee antaa osiolle "ylimääräinen" class määrittely, jota käsittelet
    omissa tyylimäärittelyissäsi</p>
